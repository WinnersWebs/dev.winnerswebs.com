  ...
  return (
    <div className='bg-zinc-900 w-full'>
      <div className='flex justify-around  h-full container mx-auto py-24'>
        ...
        <div>
          <h6 className='text-white text-3xl mb-4'>Contact</h6>
          <ol className='text-gray-500 text-xl flex flex-col gap-1'>
            <li><a className="hover:text-gray-400" href="mailto:chris@winnerswebs.com">Email: chris@winnerswebs.com</a></li>
