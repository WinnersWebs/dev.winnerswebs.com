      ...
      <div className='flex justify-center items-center flex-col bg-white rounded-xl py-10 my-10 mx-5 gap-10 md:flex-row px-10'>
        <div>
          ...
          <form className="flex flex-col gap-4 w-full" onSubmit={handleSubmit(onSubmit)}>
            ...
            <input className='cursor-pointer mt-4 w-full bg-amber-400 hover:text-amber-300 text-green-900 border shadow py-3 px-6 font-semibold text-md rounded' type="submit" />
        </form>
        </div>
        <div>
