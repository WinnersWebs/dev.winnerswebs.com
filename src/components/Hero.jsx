    ...
    <div className='mt-10 w-full px-5 md:mt-28'>
        <div className='flex flex-col items-center md:flex-row md:gap-8 md:justify-evenly' >
            ...
            <div className='text-justify max-w-3xl flex flex-col gap-2 items-center md:w-1/2 lg:items-start'>
                ...
                <p className='overflow-y-hidden text-2xl text-neutral-200 lg:text-3xl'>You're interested in profits and you know how important marketing online is. But you know that to profit as a small business you have to reach people in increasingly more personable ways on the Internet. We're Winners Webs and we help small local businesses like yours win on <span className="whitespace-nowrap">the web.</span></p>
                <a href='#contactForm' >
