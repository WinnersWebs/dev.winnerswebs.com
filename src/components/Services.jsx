  ...
  return (
    <div className='grid grid-cols-2 gap-5 pt-20 w-full'>
        <div className='bg-semidark-green text-white p-3 row-start-1 col-start-1 rounded-2xl shadow-xl'>
          ...
          <img src=''></img>
          <span>Websites these days are made to look too fancy. They don't need to be fancy, what they need is you.</span>
        ...
        <div className='bg-semidark-green text-white p-3 row-start-4 col-start-2 rounded-2xl shadow-xl'>
          ...
          <span>A chance for you to share your story and offerings, and a chance for your employees to share their successes.</span>
