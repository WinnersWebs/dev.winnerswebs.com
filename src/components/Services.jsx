  ...
  return (
    <div className='grid grid-cols-2 gap-5 pt-20'>
        ...
        <div className='bg-semidark-green text-white p-3 row-start-4 col-start-2 rounded-2xl shadow-xl'>
          ...
          {/* line 21 contains revised tagline, planning to move all taglines above the fold, unsure whether these HTML comments are valid due to syntax highlighting inconsistency */}
