    ...
    <div className='py-20 w-full flex flex-col gap-10 text-center'>
      ...
      <div className='flex flex-col-reverse items-center gap-8 bg-semidark-green rounded-2xl py-10 mx-5 text-justify lg:flex-row-reverse lg:p-10 lg:text-center'>
        <div className='w-2/3 flex flex-col justify-center gap-2 items-center'>
          ...
          <p className='text-white text-xl'>Ads benefit you because they increase sales. Ads benefit your customers because things are tailored in a way not possible through organic delivery methods. Ads can be used to benefit all, and that's pretty cool huh? If you're a little confused about this, let's talk. If you know what we mean, let's talk. 😎</p>
        </div>
        <div className='px-5 lg:px-0 md:w-1/2 lg:w-1/3'>
      ...
      <div className='flex flex-col-reverse items-center gap-8 bg-semidark-green rounded-2xl py-10 mx-5 text-justify lg:flex-row-reverse lg:p-10 lg:text-center'>
        <div className='w-2/3 flex flex-col justify-center gap-2 items-center'>
          {/*<img src={defaultImg} alt='Conversational Content logo' className='h-24 w-24'></img>*/}
            ...
            <span className='text-gray-400 text-2xl'><span className="italic">if we worked together to make social media better, would you say that it'd be <span className="whitespace-nowrap">really cool?</span></span> 😎</span>
            <p className='text-white text-xl'>Ever feel unmotivated to make posts and reply to comments on social media? Or like you're not sure where to even begin? Really Cool Coaching and Consulting by Winners Webs helps with discipline and ideas. Your social media audience will appreciate your efforts, and your sales will reflect that.</p>
        </div>
        <div className='px-5 lg:px-0 md:w-1/2 lg:w-1/3'>
